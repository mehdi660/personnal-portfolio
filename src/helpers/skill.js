...
export const inComing = [
  {
    id: 10,
    skill: <Icon icon="nonicons:node-16" className="display-4 skill" />,
    name: "NodeJS",
  },
  {
    id: 11,
    skill: <Icon icon="teenyicons:mongodb-solid" className="display-4 skill" />,
    name: "MongoDB",
  },
  {
    id: 12,
    skill: <Icon icon="tabler:file-type-sql" className="display-4 skill" />,
    name: "SQL",
  },
];
